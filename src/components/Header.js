...
const Header = () => {
    ...
    return (
        <div className="navbarh">
            <div className='row'>
                <div className='col-1' >
                    <h1 className='left mt-3' id='brand'>
                        <span>.</span>
                        Ins
                        <span>.</span>
                    </h1>
                ...
                <div className='col-3'>
                    <h2 className='left mt-3' id='brandName'>Agent's Portal</h2>
                </div>
                ...
                <div className='col-2 right'>
                    <div className='rightN'>
                        ...
                        <button className='noBorder'>
                            ...
                            <span class="position-sticky top-10 start-100 translate-middle badge rounded-pill bg-danger">
                                9+
                            </span>
                        </button>
